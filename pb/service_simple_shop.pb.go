...
var file_service_simple_shop_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x32, 0xa6, 0x09, 0x0a, 0x0a, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x53, 0x68,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x24, 0x5a, 0x22,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x68, 0x65, 0x6d, 0x65,
	0x2d, 0x63, 0x65, 0x2f, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2d, 0x73, 0x68, 0x6f, 0x70, 0x2f,
...
var file_service_simple_shop_proto_goTypes = []interface{}{
	...
	(*CreateProductResponse)(nil),          // 15: pb.CreateProductResponse
	(*UpdateProductResponse)(nil),          // 16: pb.UpdateProductResponse
	(*DeleteProductResponse)(nil),          // 17: pb.DeleteProductResponse
	(*CreateCartResponse)(nil),             // 18: pb.CreateCartResponse
	(*DeleteCartResponse)(nil),             // 19: pb.DeleteCartResponse
	(*AddCartItemResponse)(nil),            // 20: pb.AddCartItemResponse
	(*UpdateCartItemQuantityResponse)(nil), // 21: pb.UpdateCartItemQuantityResponse
	(*RemoveCartItemResponse)(nil),         // 22: pb.RemoveCartItemResponse
	(*CreateOrderResponse)(nil),            // 23: pb.CreateOrderResponse
}
var file_service_simple_shop_proto_depIdxs = []int32{
	...
	12, // 12: pb.SimpleShop.CreateUser:output_type -> pb.CreateUserResponse
	13, // 13: pb.SimpleShop.LoginUser:output_type -> pb.LoginUserResponse
	14, // 14: pb.SimpleShop.UpdateUser:output_type -> pb.UpdateUserResponse
	15, // 15: pb.SimpleShop.CreateProduct:output_type -> pb.CreateProductResponse
	16, // 16: pb.SimpleShop.UpdateProduct:output_type -> pb.UpdateProductResponse
	17, // 17: pb.SimpleShop.DeleteProduct:output_type -> pb.DeleteProductResponse
	18, // 18: pb.SimpleShop.CreateCart:output_type -> pb.CreateCartResponse
	19, // 19: pb.SimpleShop.DeleteCart:output_type -> pb.DeleteCartResponse
	20, // 20: pb.SimpleShop.AddCartItem:output_type -> pb.AddCartItemResponse
	21, // 21: pb.SimpleShop.UpdateCartItemQuantity:output_type -> pb.UpdateCartItemQuantityResponse
	22, // 22: pb.SimpleShop.RemoveCartItem:output_type -> pb.RemoveCartItemResponse
	23, // 23: pb.SimpleShop.CreateOrder:output_type -> pb.CreateOrderResponse
